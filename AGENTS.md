...
- **Domain:** Aave V3 Lending Protocol (EVM).
- **Key Library:** `@bgd-labs/aave-address-book`.
- **Features:** Supply, Withdraw, Borrow, Repay.
- **Compatibility:** Supports both EOA (`wdk-wallet-evm`) and Smart Accounts (`wdk-wallet-evm-erc-4337`).
